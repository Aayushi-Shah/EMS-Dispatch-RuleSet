...
ALS_BOUNDARY_DEFAULT = Path("reference/maps/lemsa_als_boundary_wgs84.geojson")
BLS_BOUNDARY_DEFAULT = Path("reference/maps/lemsa_bls_boundary_wgs84.geojson")
...
URBAN_GEOJSON_DEFAULT = Path("reference/maps/urban_areas_lancaster.geojson")
RURAL_GEOJSON_DEFAULT = Path("reference/maps/rural_areas_lancaster.geojson")
COUNTY_BOUNDARY_DEFAULT = Path("reference/maps/lancaster_county_boundary.geojson")
